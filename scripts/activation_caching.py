...
def cache_hooked_activations_last_token(
    hooked_model: HookedTransformer,
    iterator: DataLoader,
    activation_name: str = "resid_post",
    layer: int = 18,
    ...
    """Caches the activations of shape [4096] at the last token posiiton at a given layer and point in the layer using transformer_lens.
    ...
    def activation_hook(activation, hook):
        activations.append(activation[:, -1, :].detach().cpu())
